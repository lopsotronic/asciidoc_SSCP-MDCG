...
Using Asciidoc provides a middle path: CCS techniques but used in conjunction with DaC processes and standard open toolingfootnote:[git, visual studio code, intellij, etc].
